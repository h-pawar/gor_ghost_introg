...
# 3)  Grauer’s gorillas went through a period of population growth and range expansion citing van der valk 2018 & Tocheri 2016
t2=0.095
...
#  model this bottleneck as a temporal change
...
#------------------------------------------------------------------------------------------------------------------------
# now calc summary statistics for this ms simn
