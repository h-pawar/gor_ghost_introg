...
R CMD BATCH --vanilla --slave "--args ${ID}" /scratch/devel/hpawar/admix/abc/simul/scripts/revisions_feb23/ghoste.rev.8feb23.R /scratch/devel/hpawar/admix/abc/simul/test/ghost/revisions_8feb23/log/ghosterev_simul_${ID}.log
