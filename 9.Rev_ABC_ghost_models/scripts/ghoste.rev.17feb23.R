...
#save(simuresults,inputsets,file=paste("/scratch/devel/hpawar/admix/abc/simul/test/ghost/revisions_8feb23/ghoste/ghoste.rev.abc_sim",ptype,sep=""))

#mkdir -p /scratch/devel/hpawar/admix/abc/simul/test/ghost/revisions_8feb23/ghoste/rev_17feb23/segrecalc
