...
# @ output = /scratch/devel/hpawar/admix/sstar/log/plotnj_intersect_%j_%a.out
# @ error = /scratch/devel/hpawar/admix/sstar/log/plotnj_intersect_%j_%a.err
# @ total_tasks = 1
# @ cpus_per_task = 4
...
Rscript --vanilla  /scratch/devel/hpawar/admix/sstar/scripts/simul_postabc/downstream/plotnjintersect.29sep22.R $m $SPE $spe
