# Tue  4 Oct 2022 10:19:26 CEST
# generate random nj trees of private regions (intersect sstar-skov regions which are found only in one id of the pop)

# ls -lhtr /scratch/devel/hpawar/admix/overlap.s*.skov/privateregionsperid/random/GBB/nj
#total 0
...
a=ind
#/scratch/devel/hpawar/admix/overlap.s*.skov/privateregionsperid/random/GBB
tmp<-paste("/scratch/devel/hpawar/admix/overlap.s*.skov/regionsperid/random/",SPE,"/",spe,".",a,".random.tmp.bed",sep="")

chrom=chrom
# filter by biallelic snps only, query by the putative introg regions for id 1 & output chr, pos & gts & ref & alt alleles
...
save(rootedNJ, file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/privateregionsperid/random/",SPE,"/nj/",spe,".id.",ind,".private.random.rootedNJploutg.Robj.tree",sep=""))
...
save(random_out, file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/privateregionsperid/random/",SPE,"/nj/",spe,".id.",ind,".private.random.Robj.tree",sep=""))
