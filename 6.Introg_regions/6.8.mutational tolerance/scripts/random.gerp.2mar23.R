...
#}
#tes<-tesratiogerp_perind(random_rep1_MG_allids,all_high_polym_gerp_scores,all_low_polym_gerp_scores)
...
# this section has been superceded - Mon  6 Mar 2023 09:50:07 CET
...
#random_rep1_MG_allids[[val]]<-random_oneid(scen,val)
#}
#tes<-tesratio_highgerp_perind(random_rep1_MG_allids,all_high_polym_gerp_scores)
#return(tes)
#}
...
# only once
#ran_gerp_gbb_2mar23<-list()
#save(ran_gerp_gbb_2mar23,file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/revisions_8feb23/gerp/ran_gerp_gbb_2mar23"))
...
#val<-i
#print(val)
#ran_gerp_gbb_2mar23[[val]]<-process_onerandomrep(ov_gbb_99)}
...
#ran_gerp_gbg_2mar23<-list()
# only once 
#save(ran_gerp_gbg_2mar23,file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/revisions_8feb23/gerp/ran_gerp_gbg_2mar23"))


#for (i in 1:100){
#val<-i
#print(val)
#ran_gerp_gbg_2mar23[[val]]<-process_onerandomrep(ov_gbg_99)}
...
# after discussing with MK:
# output proportion of gerp sites that are high 
# output also low:high ratio 


tesratio_highgerp_perind<-function(scen,gerp_rang1,gerp_rang2){
...
tes<-tesratio_highgerp_perind(random_rep1_MG_allids,all_high_polym_gerp_scores,all_low_polym_gerp_scores)
return(tes)
}


ran_gerp_gbb_6mar23<-list()
for (i in 1:100){
val<-i
print(val)
ran_gerp_gbb_6mar23[[val]]<-process_onerandomrep(ov_gbb_99)}

# is taking a while to run - may be better to send as a job,..
save(ran_gerp_gbb_6mar23,file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/revisions_8feb23/gerp/ran_gerp_gbb_6mar23"))

#-----------------------------------------------------------------------------------------------------------------------

# for EL

ran_gerp_gbg_6mar23<-list()
for (i in 1:100){
val<-i
print(val)
ran_gerp_gbg_6mar23[[val]]<-process_onerandomrep(ov_gbg_99)}

save(ran_gerp_gbg_6mar23,file=paste("/scratch/devel/hpawar/admix/overlap.s*.skov/revisions_8feb23/gerp/ran_gerp_gbg_6mar23"))
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
