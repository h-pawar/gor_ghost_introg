...
# posteriors from generatewghostabc.22apr22.R
...
t_archintrog=14.0514
archaicintrog=7.0962
...
save(simuresults,inputsets,file=paste("/scratch/devel/hpawar/admix/abc/simul/test/modelcomp/final_12apr22/ghostw/test.mc.ghostw_sim",ptype,sep=""))
