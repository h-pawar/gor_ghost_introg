...
# run first for the 10 blocks (19-21)
#grep -n 'rep:10:21:10' /scratch/devel/hpawar/admix/volcanofinder/scripts/blocks_chr_23apr22.txt
#30:rep:10:21:10, 60:rep:15:18:15

# cat /scratch/devel/hpawar/admix/volcanofinder/scripts/blocks_chr_23apr22.txt | wc -l
# ie 555 array jobs
# some reps completed at 24h, many did not
# some reps still failed at 72h - may have been cluster issues influencing - need to resubmit  194-275, 286-289,306-430, 480-484, 524-525
#-----------------------------------------------------------------------------------------------------------------------
...
#/home/devel/hpawar/volcanofinder_v1.0/VolcanoFinder -big 1000 $FreqFile $SpectFile D P MODEL $OutFile BLOCK NBLOCK
# set g instead to 1000 - maybe will run faster?
