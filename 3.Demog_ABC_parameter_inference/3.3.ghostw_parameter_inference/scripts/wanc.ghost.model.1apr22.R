...
# amend below to ghost gene flow into W model
  # following # /scratch/devel/hpawar/admix/abc/simul/scripts/ghost.model.1mar22.R
  # & referring back to previous ghostw parameter inference script /scratch/devel/hpawar/admix/abc/simul/scripts/wanc.ghost.model.v1.R,called by /scratch/devel/hpawar/admix/abc/simul/scripts/wanc.ghost.model.v1.arr
#-----------------------------------------------------------------------------------------------------------------------
...
# need to go through & adjust these priors again?? **** **** YES - NEED TO BE UPDATED ***********
  # go through & check if any woudl change greatly
  # & need to amend the fixed parameters 
#------------------------------------------------------------------------------------------------------------------------
...
# need to change paths for output ** NEED TO AMEND FOR W_ANC
# mkdir -p /scratch/devel/hpawar/admix/abc/simul/test/ghost/final_1mar22/wanc/
