...
## scaled mutation rate. 4 * N * u * length # reference N = 1000
...
#------------------------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------------
# MK: You first create a generous set of values, 
...
## here, you would consider divergence times, but also directionality of population size changes, all with adding a 5% margin.
...
# fix_op is the fixed sites per individual 
