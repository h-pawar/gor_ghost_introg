...
#------------------------------------------------------------------------------------------------------------------------
# load tajima file for this ptype (this rep - of the reps with failed iterations)
load(file=paste("/scratch/devel/hpawar/admix/abc/simul/test/11sep21/tajima_21mar22/taj_sim",ptype,"",sep=""),verbose=T)
# shoudl load tajresults & inputsets

# load iterations that failed: problsimns - iter to regenerate
load(file=paste("/scratch/devel/hpawar/admix/abc/simul/test/11sep21/tajima_21mar22/problsimns",sep=""),verbose=T)
#Loading objects:
#  probl
#  problsimns
#------------------------------------------------------------------------------------------------------------------------
